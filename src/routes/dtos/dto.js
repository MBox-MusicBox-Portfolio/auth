...
var userSchemaAuth = yup.object().shape({
...
function validateUser(object) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                validate = userSchema.validateSync(object, { abortEarly: false });
                isValidate = validate !== null ? true : false;
                return [2 /*return*/, isValidate];
            }
            catch (error) {
                return [2 /*return*/, error.errors];
            }
            return [2 /*return*/];
        });
    });
 ...
 */
function validateAuth(object) {
    return __awaiter(this, void 0, void 0, function () {
        var validateAuth_1, isValidate;
        return __generator(this, function (_a) {
            try {
                validateAuth_1 = userSchemaAuth.validateSync(object, { abortEalt: false });
                isValidate = validateAuth_1 !== null ? true : false;
                return [2 /*return*/, isValidate];
            }
            catch (error) {
                return [2 /*return*/, error.errors];
